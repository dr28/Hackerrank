...
func countTriplets(arr: [Int], r: Int) -> Int {
    var count = 0
    var map4Start = [Int: Int]()
    var map4Middle = [Int: Int]()
    ...
    for num in arr {
        ...
        if num%r == 0 {
            ...
            if let count4End = map4Middle[prev] {

                count = count + count4End
            }

            if let count4Middle = map4Start[prev] {

                map4Middle[num] = (map4Middle[num] ?? 0)! + count4Middle
            }
            
            

        }
        map4Start[num] = (map4Start[num] ?? 0)! + 1
